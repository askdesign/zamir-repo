...
class EmemberPaymentButtonsListTable extends WP_List_Table {
    ...
    function column_ID($item) {
        ...
        //Build row actions
        $actions = array(
            'edit' => sprintf('<a href="admin.php?page=emember_payments&tab=edit_button&button_id=%s&button_type=%s">Edit</a>', $item['ID'], $button_type),
            'delete' => sprintf('<a href="admin.php?page=emember_payments&tab=payment_buttons&action=delete_payment_btn&button_id=%s" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a>', $item['ID']),
        );
